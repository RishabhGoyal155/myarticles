...
(function($){var msMethods={'init':function(options){this.settings={'av_title':'Available Categories','sel_title':'Selected Categories'};if(options){this.settings=$.extend(this.settings,options);}
